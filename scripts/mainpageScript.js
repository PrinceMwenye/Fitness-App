              ...
              currentUser.get()
                  .then(userDoc => {
                      ...
                      if (location == "Home") {
                          ...
                          window.location.assign("/locationworkouts/indoorworkouts.html");

                      } else if (location == "Park") {

                          window.location.assign("/locationworkouts/outdoorworkouts.html")

                      } else if (location == "Beach") {

                          window.location.assign("/locationworkouts/beach.html")
                      } else {
